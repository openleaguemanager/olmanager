...
fn row_to_team(row: &rusqlite::Row) -> rusqlite::Result<Team> {
    ...
    Ok(Team {
        ...
        weekly_scrim_plan_team_ids: weekly_scrim_plans_json.as_deref().map(|s| serde_json::from_str(s).unwrap_or_default()).unwrap_or_default(),
        ...
        scrim_reputation: scrim_reputation.unwrap_or_default(),
        ...
        scrim_reports: scrim_reports_json.as_deref().map(|s| serde_json::from_str(s).unwrap_or_default()).unwrap_or_default(),
