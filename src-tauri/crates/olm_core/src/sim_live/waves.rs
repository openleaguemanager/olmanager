...
pub(super) fn spawn_waves_if_due(runtime: &mut RuntimeState, session: &mut SimLiveSession) {
...
pub(super) fn spawn_wave(runtime: &mut RuntimeState, session: &mut SimLiveSession) {
