use crate::domain::league::{Fixture, League, StandingEntry};
...
mod tests {
    ...
    use crate::domain::league::{FixtureStatus, MatchEndReason, MatchResult, MatchType};
        ...
        league.fixtures = vec![
            ...
            Fixture {
                ...
                result: Some(MatchResult {
                    away_wins: 0,
                    home_wins: 1,
                    ended_by: crate::domain::league::MatchEndReason::TimeLimit,
