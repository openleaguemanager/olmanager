...
pub use crate::engine::sim_background::LolRole;

// ---------------------------------------------------------------------------
// DraftStrategy — mirrors crate::domain::team::DraftStrategy
// ---------------------------------------------------------------------------
...
pub struct PlayerData {
    ...
    // Traits (string names matching crate::domain::player::PlayerTrait variants)
    #[serde(default)]
