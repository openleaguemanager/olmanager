...
function toEnginePlayerFromState(
  ...
  return {
    ...
    pace: player.attributes.reaction_speed,
    stamina: player.attributes.mental_resilience,
    strength: player.attributes.durability,
    agility: player.attributes.champion_pool,
    passing: player.attributes.coordination,
    shooting: player.attributes.laning,
    tackling: player.attributes.interception,
    dribbling: player.attributes.mechanics,
    defending: player.attributes.positional_defense,
